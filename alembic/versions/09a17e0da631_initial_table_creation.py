...
Revision ID: 09a17e0da631
Revises: 
Create Date: 2023-09-10 20:47:34.514704
...
def upgrade() -> None:
    ...
    sa.Column('secrets', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
